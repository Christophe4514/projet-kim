  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification d'un personnel</h3>
              </div>
      ...
      {!! Form::model($personnel, [
        'method' => 'PATCH',
        'route' => ['personnels.update', $personnel->id],
    ...
    <div class="card-body">
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('names', null, ['placeholder' => 'Nom Complet', 'class' => 'form-control']) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>{{ __('Poste') }}:</strong>
