<div class="banner-carousel banner-carousel-1 mb-0">
    <div class="banner-carousel-item" style="background-image:url({{ asset('front-end/images/4M4A0603.jpg') }})">
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('front-end/images/4M4A0611.jpg') }})">
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('front-end/images/4M4A0616.jpg') }})">
