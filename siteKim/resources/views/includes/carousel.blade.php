<div class="banner-carousel banner-carousel-1 mb-0">
    <div class="banner-carousel-item" style="background-image:url({{ asset('front-end/images/slider-main/bg1.jpg') }})">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <p data-animation-in="slideInLeft" data-duration-in="1.2">
                            <a href="services.html" class="slider btn btn-primary"
                                style="background-color: #03224c;">Our Services</a>
                            <a href="contact.html" class="slider btn btn-primary border"
                                style="background-color: #03224c;">Contact Now</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('front-end/images/slider-main/bg2.jpg') }})">
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('front-end/images/slider-main/bg3.jpg') }})">
                    ...
                    <div class="col-md-12">
                        ...
                        <div data-animation-in="slideInLeft">
                            <a href="contact.html" class="slider btn btn-primary" aria-label="contact-with-us"
                                style="background-color: #03224c;">Get Free
                                Quote</a>
